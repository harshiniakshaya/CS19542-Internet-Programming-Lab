...
const DonateFood = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Thank you for donating food! Your contribution makes a difference."
      );
      setFormData({
        latitude: "",
        longitude: "",
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="px-4 py-2 border border-white rounded-md w-full">
              {formData.foodType ? formData.foodType : "Select Food Type"}
            </DropdownMenuTrigger>
            <DropdownMenuContent className="bg-orange-600 border-white text-white">
              <DropdownMenuLabel>Food Type</DropdownMenuLabel>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => handleFoodTypeSelect("Veg")}>
                Veg
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleFoodTypeSelect("Non-Veg")}>
                Non-Veg
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleFoodTypeSelect("Both")}>
                Both
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
